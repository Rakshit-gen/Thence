...
//                 />
//             </div>
//             <button className='w-[417px] pt-[26.11px] pr-[49.61px] pb-[26.11px] pl-[41.78px] rounded-full bg-[#C9C9C9] mt-10 font-Manrope font-semibold text-[18px] text-white'>Submit</button>
//         </div>
//     </main>
//   )
// }
